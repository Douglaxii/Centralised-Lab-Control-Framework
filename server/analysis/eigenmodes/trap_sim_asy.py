...
def calculate_eigenmode(
    ...
    *,
    ...
    theta_deg : float, optional
        Rotation angle around x-axis [degrees]. Default: 0.
    z_offset : float, optional
        Z-axis offset [m]. Default: 0.
    ...
    # Apply z_offset and rotation
    coords_with_offset = positions_opt.copy()
    coords_with_offset[:, 2] += z_offset
    ...
    coords_rotated = coords_with_offset @ R_matrix.T
    z_eq_with_offset = coords_with_offset[:, 2].copy()
    ...
    return freqs_hz, eigenvectors, z_eq_with_offset, coords
...
if __name__ == "__main__":
    ...
    freqs, V, z_eq, coords = calculate_eigenmode(
        ...
        theta_deg=theta_deg, z_offset=z_offset
    )
