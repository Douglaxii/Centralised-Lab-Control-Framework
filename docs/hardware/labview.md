...
2. **Control Manager**: Publishes emergency zero commands to workers
3. **LabVIEW Worker**: Direct hardware commands (final layer)

See [Safety Kill Switch Guide](../guides/SAFETY_KILL_SWITCH.md) for complete documentation.
...
See [Data Formats](../reference/data_formats.md) for complete details.
