...
- [Camera Activation Guide](../guides/CAMERA_ACTIVATION.md) - Operating the camera system
- [Image Handler](../camera/IMAGE_HANDLER_README.md) - Frame processing documentation
