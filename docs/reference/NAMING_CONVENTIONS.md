...
## 8. File Renaming Mapping

### 8.1 Current → Target File Names

| Current Path | Target Path | Status |
|--------------|-------------|--------|
| `artiq/fragments/comp.py` | `artiq/fragments/compensation.py` | Pending |
| `artiq/fragments/ec.py` | `artiq/fragments/endcaps.py` | Pending |
| `artiq/fragments/cam.py` | `artiq/fragments/camera.py` | Pending |
| `artiq/fragments/Raman_board.py` | `artiq/fragments/raman_board.py` | Pending |
| `artiq/fragments/secularsweep.py` | `artiq/fragments/secular_sweep.py` | Pending |

### 8.2 Import Updates Required

When files are renamed, update imports in:

1. `artiq/experiments/trap_controler.py`
   - Change: `from comp import Compensation` → `from compensation import Compensation`
   - Change: `from ec import EndCaps` → `from endcaps import EndCaps`

2. Any experiment files using fragments
3. Test files referencing fragments

---

## 9. Variable Renaming Mapping

### 9.1 RF Voltage Variables

| Current (Deprecated) | New Standard | Context |
|---------------------|--------------|---------|
| `u_rf` (meaning mV) | `u_rf_mv` | SMILE interface value |
| `u_rf` (meaning V) | `U_rf_v` | Real trap voltage |
| `U_RF` | `U_rf_v` | Real trap voltage |
| `urf` | `u_rf_mv` | SMILE interface value |

### 9.2 DC Electrode Variables

| Current | New Standard | Notes |
|---------|--------------|-------|
| `u_ec1` | `ec1_voltage` | More descriptive |
| `u_ec2` | `ec2_voltage` | More descriptive |
| `u_hor` | `comp_h_voltage` | More descriptive |
| `u_ver` | `comp_v_voltage` | More descriptive |
